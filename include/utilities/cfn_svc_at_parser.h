...
struct cfn_svc_at_parser_api_s
{
    ...
    cfn_hal_error_code_t (*register_urc)(cfn_svc_at_parser_t      *driver,
                                         ...
                                         void                     *user_arg);
    cfn_hal_error_code_t (*register_urc_simple)(cfn_svc_at_parser_t *driver, const char *urc_string, void *callback);
...
CFN_HAL_INLINE cfn_hal_error_code_t cfn_svc_at_register_urc_simple(cfn_svc_at_parser_t *driver,
