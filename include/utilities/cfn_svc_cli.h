...
cfn_hal_error_code_t cfn_svc_cli_construct(cfn_svc_cli_t *driver, const cfn_svc_cli_config_t *config, const cfn_svc_cli_phy_t *phy, cfn_svc_cli_callback_t callback, void *user_arg);
