...
typedef struct
{
    void *instance; /*!< Mapping to lower-layer driver (UART, USB, SPI, Radio) */
    void *user_arg;
} cfn_svc_transport_phy_t;
...
CFN_SVC_CREATE_DRIVER_TYPE(svc_transport,
                           cfn_svc_transport_config_t,
                           cfn_svc_transport_api_t,
                           cfn_svc_transport_phy_t,
                           cfn_svc_transport_callback_t);

#define CFN_SVC_TRANSPORT_INITIALIZER(api_ptr, phy_ptr, config_ptr)                                                    \
    CFN_SVC_DRIVER_INITIALIZER(CFN_SVC_TYPE_TRANSPORT, api_ptr, phy_ptr, config_ptr)
...
CFN_HAL_INLINE void cfn_svc_transport_populate(cfn_svc_transport_t              *driver,
                                         ...
                                         const cfn_svc_transport_phy_t    *phy,
...
cfn_hal_error_code_t cfn_svc_transport_construct(cfn_svc_transport_t *driver, const cfn_svc_transport_config_t *config, const cfn_svc_transport_phy_t *phy, cfn_svc_transport_callback_t callback, void *user_arg);
