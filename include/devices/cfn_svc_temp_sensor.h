...
CFN_SVC_CREATE_DRIVER_TYPE(
    svc_temp_sensor, cfn_svc_temp_config_t, cfn_svc_temp_sensor_api_t, cfn_svc_temp_phy_t, cfn_svc_temp_callback_t);
...
cfn_hal_error_code_t cfn_svc_temp_sensor_construct(cfn_svc_temp_sensor_t *driver, const cfn_svc_temp_config_t *config, const cfn_svc_temp_phy_t *phy, cfn_svc_temp_callback_t callback, void *user_arg);
