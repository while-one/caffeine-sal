...
CFN_SVC_CREATE_DRIVER_TYPE(
    svc_display, cfn_svc_display_config_t, cfn_svc_display_api_t, cfn_svc_display_phy_t, cfn_svc_display_callback_t);
...
CFN_HAL_INLINE void cfn_svc_display_populate(cfn_svc_display_t              *driver,
                                         ...
                                         const cfn_svc_display_phy_t    *phy,
...
cfn_hal_error_code_t cfn_svc_display_construct(cfn_svc_display_t *driver, const cfn_svc_display_config_t *config, const cfn_svc_display_phy_t *phy, cfn_svc_display_callback_t callback, void *user_arg);
