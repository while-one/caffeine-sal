...
CFN_SVC_CREATE_DRIVER_TYPE(
    svc_hum_sensor, cfn_svc_hum_config_t, cfn_svc_hum_sensor_api_t, cfn_svc_hum_phy_t, cfn_svc_hum_callback_t);
...
cfn_hal_error_code_t cfn_svc_hum_sensor_construct(cfn_svc_hum_sensor_t *driver, const cfn_svc_hum_config_t *config, const cfn_svc_hum_phy_t *phy, cfn_svc_hum_callback_t callback, void *user_arg);
