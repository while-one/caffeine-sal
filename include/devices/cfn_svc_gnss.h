...
cfn_hal_error_code_t cfn_svc_gnss_construct(cfn_svc_gnss_t *driver, const cfn_svc_gnss_config_t *config, const cfn_svc_gnss_phy_t *phy, cfn_svc_gnss_callback_t callback, void *user_arg);
